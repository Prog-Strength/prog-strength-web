 ...
 * time) over a heart-rate-vs-elapsed-time chart. Rendered only when enrichment
 * is present; inserted between the numbers row and the exercise list, leaving
 * the rest of the session-recap layout untouched.
 */
