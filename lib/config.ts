...
export const config = {
  ...
  // Gate for the throwaway Design Exploration route
  // (/design-explore/activities-page). OFF unless explicitly enabled, so the
  // mockup is unreachable in normal navigation and dead in production. Set
  // NEXT_PUBLIC_DESIGN_EXPLORE=1 locally / on a preview deploy to view it.
  // See dx/activities-page in prog-strength-docs.
  designExploreEnabled: process.env.NEXT_PUBLIC_DESIGN_EXPLORE === "1",
};
